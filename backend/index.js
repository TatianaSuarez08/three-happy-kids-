...
import requireGateway from './src/middleware/gateway.js';
...
const server = app.listen(PORT, async () => {
    try {
        ...
        console.error(`No se pudo conectar a MySQL en ${env.DB_HOST}/${env.DB_DATABASE}. Revisa el .env raíz.`, error.message);
